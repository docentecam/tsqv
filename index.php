	...
	<body>
		...
		<div class="row">
			<div class="col-sm text-center">
					<span class="ES">3 CATEGORÍAS:</span><span class="CA" style="display: none">3 CATEGORIES</span><br>
		...
		<div class="row">
			<div class="col-sm text-center" >
				<span class="ES text-center" style="display: none" >INSCRIPCIONES</span><span class="CA" style="display: none">INSCRIPCIONS </span><br>
				<span class="ES" style="display: none" >Hasta el 10 de junio, presencialmente en el Centre Cívic Besòs</span><span class="CA" style="display: none">Fins al 10 de juny presencialment al Centre Cívic Besòs </span><br>
				<span class="ES" style="display: none">(rambla Prim 87-89, Metro L4 Besòs Mar)</span><span class="CA" style="display: none">(rambla Prim 87-89, Metro L4 Besòs Mar)</span><br>
				 <span class="ES" style="display: none">o enviando un mail a tusiquevales.bm@gmail.com </span><span class="CA" style="display: none">o enviant un mail a tusiquevales.bm@gmail.com</span><br>
				<span class="ES" style="display: none">Más info al 93 256 49 01 / 617 252 908</span><span class="CA" style="display: none">Més info al 93 256 49 01 / 617 252 908</span>
			</div>
		</div>
	</div>
